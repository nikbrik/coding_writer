...
- Deterministic process loop уже реализован через `ProcessController`, `StagePolicyRegistry`, `StagePromptFactory`, validators, bounded retry, `TransitionGate` и `process_audit.jsonl`.
